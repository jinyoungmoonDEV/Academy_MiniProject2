...
public class BoardService {
	...
	public String testService() {
		...
		// TodoEntity 검색
		BoardEntity savedEntity = boardRepository.findById(entity.getId()).get();
	...
	public List<BoardEntity> create(final BoardEntity entity) {
		...
		return boardRepository.findByUserId(entity.getUserId());
	}
	...
	public List<BoardEntity> update(final BoardEntity entity) {
		...
		final Optional<BoardEntity> original = boardRepository.findById(entity.getId());
